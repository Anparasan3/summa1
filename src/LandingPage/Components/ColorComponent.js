...
import {
  ...
  Button,
} from "../Style/LandingPageStyledComponent";
    ...
    <LandingPageBodyColorCenter Center={Props.Center}>
      {Props.Product.color ? (
        ...
        >
          <div
            className={
              Props.Type === "Type3" || Props.Align === "Vertical"
                ? "LandingPageBodyColorHeadInvisible"
                : "LandingPageBodyColorHead"
            }
          >
            Colors:{" "}
          </div>
